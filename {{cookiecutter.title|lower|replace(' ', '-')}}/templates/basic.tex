...
\setmonofont[Mapping=]{DejaVuSansMono}
\newfontfamily\monospace[Mapping=]{DejaVuSansMono}
\defaultfontfeatures{Ligatures=TeX}
\newfontfamily\headingfont[]{DejaVuSerif}
\newfontfamily\headingfontlight[]{DejaVuSerif}
